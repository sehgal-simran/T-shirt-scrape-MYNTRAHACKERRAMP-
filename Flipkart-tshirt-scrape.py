...
url="https://www.flipkart.com/mens-tshirts/pr?sid=clo%2Cash%2Cank%2Cedy&otracker[]=categorytree&otracker[]=nmenu_sub_Men_0_T-Shirts"
x= requests.get(url)
...
df.to_csv(r'tshirt-flipkart-final-final.csv')
